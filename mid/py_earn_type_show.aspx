<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="py_earn_type_show.aspx.cs" Inherits="mid.py_earn_type_show" %>
<<<<<<< HEAD
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-default col-lg-12">
        <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">عرض أنواع الاستحقاقات</h2>
        </div>
    </div>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div class="content-wrapper">
        ...
        <ol class="breadcrumb" style="width: 1050px;">
            <h1><small>اعدادات الموظفين < عرض انواع الاستحقاقات </small></h1>
        </ol>
        <div class="row">
            <div class="col-xs-12">
