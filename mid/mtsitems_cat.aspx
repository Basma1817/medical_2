<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="mtsitems_cat.aspx.cs" Inherits="mid.mtsitems_cat" %>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row" style="margin-top: 10px">
                                        ...
                                        <div style="display: flex; margin-top: 10px">
                                            <div class="col-md-6">
                                                <div style="display: flex">
                                                    <asp:Label ID="Label27" Style="width: 16%" runat="server" Text="رقم المرجع"></asp:Label>
                                            ...
                                            <div class="col-md-6 pull-right">
                                                <div style="display: flex; margin-top: 10px">
                                                    <asp:Label ID="Label28" Style="width:16%" runat="server" Text="حجم الباركود"></asp:Label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 pull-right">
                                         <asp:CheckBox ID="CheckBox11" runat="server" Text="تفعيل الكمية بالوحدة الثالثة" />
                                                </div>
                                            <div class="col-md-6 pull-right">
                                    <asp:CheckBox ID="CheckBox10" runat="server" Text="تفعيل الكمية بالوحدة الثانية" />
                                </div>
                              </div>
        ...
        <div id="details" class="tab-pane fade" style="margin-top:10px">
            ...
            <div class="row">
               ...
               <div class="panel panel-primary col-lg-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                            <asp:Label Text="ملاحظات 1" runat="server" />
                            <asp:TextBox ID="TextBox30"  Style="width: 73%" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                    <div class="col-md-12">
                            <asp:Label Text="ملاحظات 2" runat="server" />
                            <asp:TextBox ID="TextBox31" Style="width: 73%" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                </div>
              </div>
