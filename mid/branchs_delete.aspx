<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="branchs_delete.aspx.cs" Inherits="mid.branchs_delete" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <section class="content-header">
         ...
         <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">حذف فرع</h2>
        </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <tr class="jsgrid-row">
                                    <td class="jsgrid-cell">
                                        <asp:Button ID="Button4" Style="margin: 0 60%; color: white; height: 30px; background-color: #dc3545; width: 52px; border: none;" runat="server" Text="حذف" OnClick="Button4_Click" />
                                    </td>
