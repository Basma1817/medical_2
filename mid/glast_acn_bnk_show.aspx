<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="glast_acn_bnk_show.aspx.cs" Inherits="mid.glast_acn_bnk_show" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

<<<<<<< HEAD
    <div class="panel panel-default col-lg-12">
        <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">عرض بيانات البنوك والصندوق </h2>
        </div>
    </div>
    <div class="row">
...
=======
     <div class="content-wrapper">
        <ol class="breadcrumb" style="width: 1050px;">
            <h1><small>اعدادات الحسابات < عرض بيانات البنوك و الصندوق </small></h1>
        </ol>
                        ...
                        <div>
                            <table id="example2" class="table table-borderless">
                                <thead>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Button ID="Button3" Style="margin: -3px -94% 50px -55%; height: 30px; width: 52px; background-color: #dc3545;" runat="server" Text="تراجع" OnClick="Button3_Click" />
                                        </td>
                                    </tr>
                            </table>
                        </div>
