<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="viewInovice.aspx.cs" Inherits="mid.viewInovice" EnableEventValidation="false" %>
    ...
    <body>
        <div>
            <ol class="breadcrumb" style="width: 100%;">
                <h1><small>المشتريات < عرض فاتورة الشراء </small></h1>
            </ol>
            <div>
                <table class="table">
                    <tr>
                        <td>الفرع</td>
                        <td>
                            <asp:DropDownList ID="drpBranch" runat="server" Style="width: 124px;"></asp:DropDownList></td>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="اسم الصنف" SortExpression="Itm_NmAr" ItemStyle-Width="100px">
                        <EditItemTemplate>
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSource3" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' SelectCommand="SELECT [Itm_No], [Itm_NmAr] FROM [MtsItmmfs]"></asp:SqlDataSource>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="Label5" runat="server" Text='<%# Bind("Itm_NmAr") %>' Width="125px"></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:DropDownList ID="drpInsertItm_NmAr" runat="Server" DataSourceID="SqlDataSource2" DataTextField="Itm_NmAr" DataValueField="Itm_No" Width="125px" AutoPostBack="True" OnSelectedIndexChanged="drpInsertItm_NmAr_SelectedIndexChanged" AppendDataBoundItems="true">
                                <asp:ListItem Selected="True" Value="0">اختر صنفاً</asp:ListItem>
                            </asp:DropDownList>
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' SelectCommand="SELECT [Itm_No], [Itm_NmAr] FROM [MtsItmmfs]"></asp:SqlDataSource>
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="الوحدة" SortExpression="Unit_NmAr">
                        <EditItemTemplate>
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSource4" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' SelectCommand="SELECT [Unit_No], [Unit_NmAr] FROM [ItmsUnit]"></asp:SqlDataSource>
                        </EditItemTemplate>
                        <ItemTemplate>
                        ...
                        <FooterTemplate>
                            ...
                            <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' SelectCommand="SELECT [Unit_No], [Unit_NmAr] FROM [InvItmunit]"></asp:SqlDataSource>
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="الكمية" SortExpression="Qty">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtEditQty" runat="server" Text='<%# Bind("Qty") %>' TextMode="Number" Width="35px" OnPreRender="txtEditQty_PreRender" AutoPostBack="true"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="label3" runat="server" Text='<%# Bind("Qty") %>' Width="35px"></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="TextBox9" runat="Server" TextMode="Number" Width="30px" OnPreRender="TextBox9_PreRender" AutoPostBack="true" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="سعر شراء الوحدة" SortExpression="Itm_Pur">
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="txtItm_PurFooter" runat="Server" TextMode="Number" Width="45px" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="تاريخ الصلاحية" SortExpression="Exp_Date">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtExp_Date" runat="server" Text='<%# Bind("Exp_Date") %>' placeholder="شهر/سنة" Width="45px"></asp:TextBox>
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="Exp_DateFooter" runat="Server" placeholder="شهر/سنة" Width="40px" />
                    ...
                    <asp:TemplateField HeaderText="رقم التشغيلة" SortExpression="Batch_No">
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="Batch_NoFooter" runat="Server" Width="35px" />
                        </FooterTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="نسبة خصم 1 %" SortExpression="Disc1_Prct">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtDisc1_Prct" runat="server" Text='<%# Bind("Disc1_Prct") %>' TextMode="Number" Width="40px" OnPreRender="txtDisc1_Prct_OnPreRender" AutoPostBack="true"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblDisc1_Prct" runat="server" Text='<%# Bind("Disc1_Prct") %>' Width="40px"></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="Disc1_PrctFooter" runat="Server" TextMode="Number" Width="40px" OnPreRender="Disc1_PrctFooter_OnPreRender" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="قيمة الخصم" SortExpression="Disc1_Val">
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="Disc1_ValFooter" runat="Server" TextMode="Number" Width="40px" />
                        </FooterTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="نسبة خصم 2 %" SortExpression="Disc2_Prct">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtDisc2_Prct" runat="server" Text='<%# Bind("Disc2_Prct") %>' TextMode="Number" Width="40px" AutoPostBack="true"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblDisc2_Prct" runat="server" Text='<%# Bind("Disc2_Prct") %>' Width="40px"></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="Disc2_PrctFooter" runat="Server" TextMode="Number" Width="40px" />
                        </FooterTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="نسبة بونص شراء 1 %" SortExpression="BonusPur_Prct">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtBonusPur_Prct" runat="server" Text='<%# Bind("BonusPur_Prct") %>' TextMode="Number" Width="40px" OnTextChanged="txtBonusPur_Prct_OnTextChanged" OnPreRender="txtBonusPur_Prct_OnPreRender"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblBonusPur_Prct" runat="server" Text='<%# Bind("BonusPur_Prct") %>' Width="40px"></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="BonusPur_PrctFooter" runat="Server" TextMode="Number" Width="40px" OnTextChanged="BonusPur_PrctFooter_OnTextChanged" OnPreRender="BonusPur_PrctFooter_OnPreRender" />
                        </FooterTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="كمية بونص الشراء" SortExpression="BonusPur_Qty">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtBonusPur_Qty" runat="server" Text='<%# Bind("BonusPur_Qty") %>' TextMode="Number" Width="40px" OnTextChanged="txtBonusPur_Qty_OnTextChanged"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblBonusPur_Qty" runat="server" Text='<%# Bind("BonusPur_Qty") %>' Width="40px"></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="BonusPur_QtyFooter" runat="Server" TextMode="Number" Width="40px" OnTextChanged="BonusPur_QtyFooter_OnTextChanged" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="سعر البيع" SortExpression="Itm_Sal">
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="Itm_SalFooter" runat="Server" TextMode="Number" Width="40px" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="قيمة البيع" SortExpression="Titm_Sal">
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="Titm_SalFooter" runat="Server" TextMode="Number" Width="40px" />
                        </FooterTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="تكلفة الصنف" SortExpression="Titm_Cost">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtTitm_Cost" runat="server" Text='<%# Bind("Titm_Cost") %>' TextMode="Number" Width="40px" OnPreRender="txtTitm_Cost_OnPreRender"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblTitm_Cost" runat="server" Text='<%# Bind("Titm_Cost") %>' Width="40px"></asp:Label>
                        </ItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="Titm_CostFooter" runat="Server" TextMode="Number" Width="40px" OnPreRender="Titm_CostFooter_OnPreRender" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="تكلفة الوحدة" SortExpression="Itm_Cost">
                        ...
                        <FooterTemplate>
                            <asp:TextBox ID="Itm_CostFooter" runat="Server" TextMode="Number" Width="40px" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="ضريبة % " SortExpression="taxp_Extra">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtEditTaxp_Extra" runat="server" Text='<%# Bind("taxp_Extra") %>' Width="40px" AutoPostBack="true"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:ImageButton ID="btnAdd" runat="server" Text="Add" OnClick="AddNewRecord" ImageUrl="~/wp-content/image/add-logo.png" Width="30px" Height="20px" ToolTip="اضافة صف جديد" AlternateText="اضافة صف جديد" CausesValidation="false" /></HeaderTemplate>
        ...
        <div style="margin: 10px">
            <table id="FooterTable" class="table " style="width: 400px; height: 50px;" runat="server">
                <tr>
                    <td>الاجمالي</td>
                    <td>
                        <asp:TextBox ID="txtTotalPriceFooter" runat="server" ReadOnly="true" OnPreRender="txtTotalPriceFooter_PreRender"></asp:TextBox></td>

                    <td>بعد الخصم</td>
                    <td>
                        <asp:TextBox ID="txtAfterDiscountFooter" runat="server" ReadOnly="true" OnPreRender="txtAfterDiscountFooter_PreRender"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>خصم اصناف</td>
                    <td>
                        <asp:TextBox ID="txtDiscountItemsFooter" runat="server" ReadOnly="true" OnPreRender="txtDiscountItemsFooter_PreRender" AutoPostBack="true"></asp:TextBox>
                        <asp:TextBox ID="txtDiscountItems2Footer" runat="server"></asp:TextBox>
                    </td>
                    <td>الضرائب</td>
                    <td>
                        <asp:TextBox ID="txtTaxFooter" runat="server" ReadOnly="true" OnPreRender="txtTaxFooter_PreRender"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>خصم اضافي</td>
                    <td>
                        <asp:TextBox ID="txtAdditionalDiscountFooter" runat="server" AutoPostBack="true"></asp:TextBox>
                        <asp:TextBox ID="txtAdditionalDiscount2Footer" runat="server"></asp:TextBox>
                    </td>
                    <td>الصافي</td>
                    <td>
                        <asp:TextBox ID="txtNetFooter" runat="server" ReadOnly="true" OnPreRender="txtNetFooter_PreRender"></asp:TextBox></td>
                    <td>قيمة البونص</td>
                    <td>
            ...
            <div class="modal-footer">
                <table class="table" style="width: 250px; padding: 0; margin: auto">
                    <tr>
                        <%--<td>
                            <asp:Button ID="btnSave" runat="server" Text="تحديث" CssClass="btn btn-primary" Style="border: 1px solid transparent; padding: 0.375rem 0.75rem;"
                                OnClick="btnSave_Click" OnClientClick="if (!deleteConfirmation2()) return false;" />
                        </td>--%>
                        <td>
                            <asp:Button ID="btnCancel" runat="server" Text="تراجع" CssClass="btn btn-primary" Style="background-color: firebrick; border: 1px solid transparent; padding: 0.375rem 0.75rem;" PostBackUrl="~/HomePurchasingInvoice.aspx" />

                        </td>

                       <%-- <td>
                            <asp:LinkButton ID="Button1" runat="server" Text="فاتورة شراء جديدة" CssClass="btn btn-primary" Style="background-color: cornflowerblue; border: 1px solid transparent; padding: 0.375rem 0.75rem; width: 130px;"
                                PostBackUrl="~/purchasingInovice.aspx" CausesValidation="false" />
                        </td>--%>
                    </tr>
                </table>
            </div>
