<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="suplier_delete.aspx.cs" Inherits="mid.suplier_delete" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div class="content-wrapper">
        <ol class="breadcrumb" style="width: 1050px;">
            <h1><small>البيانات الأساسية < حذف البيانات الأساسية للموردين </small></h1>
        </ol>
                            ...
                            <div class="box-body">
                                <table id="example2" class="table table-borderless">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                 <asp:Button ID="Button1" Style="margin: 3px 82% 0 0; background-color: #dc3545; height: 30px; background-color: #007bff; width: 52px" runat="server" Text="حذف" OnClick="Button1_Click" />
                                            </td>
                                            <td>
