...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">حذف تصنيف الموردين و العملاء</h2>
        </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-5" style="display: flex; justify-content: flex-end">
            <asp:Button ID="Button3" runat="server" type="submit" Text="حذف" OnClick="Button3_Click" class="btn btn-success" />
            <asp:Button ID="Button4" runat="server" type="submit" Text="تراجع" OnClick="Button4_Click" class="btn btn-success" />
        </div>
    </div>
