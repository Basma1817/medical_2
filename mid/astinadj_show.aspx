<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="astinadj_show.aspx.cs" Inherits="mid.astinadj_show" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
         ...
         <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">عرض حسابات التسويه بالمخازن</h2>
        </div>
        </div>
     <div class="row">
...
<%--<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content-wrapper">
        ...
        <ol class="breadcrumb" style="width: 1050px;">
            <h1><small>لوحة التحكم < عرض حسابات التسويه بالمخازن</small></h1>
        </ol>
        <div class="row">
            <div class="col-xs-12">
                            ...
                            <table id="example2" class="table table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBox1" Enabled="false" runat="server" Style="width: 100px; text-align: center; margin-left: 90%;"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>
