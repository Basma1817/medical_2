<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ast_area_show.aspx.cs" Inherits="mid.ast_area_show" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      <div class="content-wrapper">
        <ol class="breadcrumb" style="width: 1050px;">
            <h1><small>اعدادات المبيعات < عرض منطقه</small></h1>
        </ol>
                            ...
                            <table id="example2" class="table table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DropDownList1" Enabled="false" runat="server"></asp:DropDownList></td>
                                    </tr>
                                  <tr>
                                        <td>
