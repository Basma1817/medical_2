<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="insertastbank.aspx.cs" Inherits="mid.insertastbank" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
         ...
         <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">اضافة البيانات الاساسيه للبنوك</h2>
        </div>
        </div>
     <div class="row">
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="content-wrapper">
        <ol class="breadcrumb" style="width: 1050px;">
            <h1><small>اعدادت الحسابات < اضافة البيانات الاساسيه للبنوك</small></h1>
        </ol>
