...
=======
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <h1 style="padding-left: 625px;"><small>الاعدادات العامة > أنواع المراجع للسندات</small></h1>
        </ol>
        ...
        <div class="wrapper" id="app" style="float: left; width: 100%; margin-right: 30px;">
            ...
            <div style="width: 100px; position: center; height: 935px; justify-content: center; width: 100%; padding-left: 55px; padding-right: 40px; text-align: center;">
                <asp:GridView ID="GridView1" GridLines="None" CssClass="table table-striped" Style="direction: ltr; font-size: 14px;" BackColor="White" runat="server" OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="True">
                    <Columns>
                         <asp:HyperLinkField ControlStyle-BackColor="red" ControlStyle-ForeColor="White" ControlStyle-CssClass="p-2" DataNavigateUrlFields="رقم_النوع" DataNavigateUrlFormatString="ref_type_main_delete.aspx?no={0}" HeaderText="حذف" NavigateUrl="~/ref_type_main_delete.aspx" Text='<i class="fa fa-trash"></i>' />



                        <asp:HyperLinkField ControlStyle-BackColor="Green" ControlStyle-ForeColor="White" ControlStyle-CssClass="p-2" DataNavigateUrlFields="رقم_النوع" DataNavigateUrlFormatString="updatedelereftypmain.aspx?no={0}" HeaderText="تعديل" NavigateUrl="~/updatedelereftypmain.aspx" Text='<i class="fa fa-edit"></i>' />


                         <asp:HyperLinkField ControlStyle-BackColor="#3c8dbc" ControlStyle-ForeColor="White" ControlStyle-CssClass="p-2" DataNavigateUrlFields="رقم_النوع" DataNavigateUrlFormatString="ref_type_main_show.aspx?no={0}" HeaderText="عرض" NavigateUrl="~/ref_type_main_show.aspx" Text='<i class="fa fa-edit"></i>'>
