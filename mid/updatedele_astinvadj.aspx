<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="updatedele_astinvadj.aspx.cs" Inherits="mid.updatedele_astinvadj" %>
...
<<<<<<< HEAD
         ...
         <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">تعديل حسابات التسويه بالمخازن</h2>
        </div>
        </div>
     <div class="row">
...
=======
    <div class="content-wrapper">
        ...
        <ol class="breadcrumb" style="width: 1050px;">
            <h1><small>اعدادات الحسابات > تعديل حسابات التسويه بالمخازن</small></h1>
        </ol>
        <div class="row">
            <div class="col-xs-12">
