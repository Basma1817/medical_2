...
namespace mid
{
    public partial class update_delete_mts_custm : System.Web.UI.Page
    {
             ...
             protected void load_tree()
        {
            ...
            foreach (MtsCustmr sup in db.MtsCustmr.Where(o => o.Cmp_No == no && o.Parent_Cstm == 0))
            {
                TreeNode node = new TreeNode();
                node.Text = sup.Cstm_NmAr.ToString();
                node.Value = sup.Cstm_No.ToString();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(TextBox14.Text) || !string.IsNullOrWhiteSpace(TextBox14.Text))
                    cn.Cstm_No = Convert.ToInt16(TextBox14.Text);
                ...
                if (!string.IsNullOrEmpty(DropDownList2.SelectedValue) || !string.IsNullOrWhiteSpace(DropDownList2.SelectedValue))
                    DropDownList2.SelectedValue = Convert.ToString(cn.Catg_No);
