<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="updatecompanies.aspx.cs" Inherits="mid.updatecompanies" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <section class="content-header">
         ...
         <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">تعديل بيانات الشركة </h2>
        </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <tr class="jsgrid-alt-row">
                                    <td class="jsgrid-cell">
                                        <asp:Button ID="Button1" Style="color:white; height: 30px; background-color: #007bff; width: 52px;     margin: 0 60%; border:none;" runat="server" Text="حفظ" OnClick="Button1_Click" /></td>

                                    <td class="jsgrid-cell jsgrid-align-right">
                                        <asp:Button ID="Button3" Style=" color:white; height: 30px; background-color: #dc3545; width: 52px; border:none;" runat="server" Text="تراجع" OnClick="Button3_Click" /></td>
