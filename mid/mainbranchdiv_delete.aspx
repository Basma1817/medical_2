<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="mainbranchdiv_delete.aspx.cs" Inherits="mid.mainbranchdiv_delete" %>
         ...
         <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">حذف مكان تسليم البضاعة</h2>
        </div>
        </div>
                <div class="card-body">
                    <div>
                            ...
                            <tbody>
                                ...
                                <tr class="jsgrid-row">
                                    <td class="jsgrid-cell">
                                        <asp:Button ID="Button4" Style="color:white; height: 30px; background-color: #dc3545; width: 52px;     margin: 0 65%; border:none;" runat="server" Text="حذف" OnClick="Button4_Click" /> 
