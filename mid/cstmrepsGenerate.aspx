<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cstmrepsGenerate.aspx.cs" Inherits="mid.cstmrepsGenerate" EnableEventValidation="false" %>


<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <ol class="breadcrumb">
        <h1 style="padding-left: 717px;"><small>البيانات الاساسيه < تقارير العملاء</small></h1>
    </ol>
    ...
    <div style="float: right; width: 33%;" dir="rtl">
        <fieldset style="text-align: justify; margin: 65px;">
            ...
            <asp:RadioButtonList ID="RadioButtonList1" runat="server" BorderColor="Black" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged" AutoPostBack="True" style="font-size:20px">
                ...
                <asp:ListItem>مندوب المبيعات</asp:ListItem>
                <asp:ListItem>نوع النشاط</asp:ListItem>
                <asp:ListItem>المدينة</asp:ListItem>
                <asp:ListItem>المنطقة</asp:ListItem>
                <asp:ListItem>مندوب التسويق</asp:ListItem>
    ...
    <div style="float: right; width: 33%; direction: rtl">
        <fieldset style="text-align: justify; margin: 65px;">
            ...
            <asp:RadioButtonList ID="RadioButtonList2" runat="server" AutoPostBack="True" OnSelectedIndexChanged="RadioButtonList2_SelectedIndexChanged" style="font-size:20px">
                ...
                <asp:ListItem>تفاصيل العنوان</asp:ListItem>
                <asp:ListItem>قائمة العملاء</asp:ListItem>
                <asp:ListItem>تفاصيل قائمة العملاء</asp:ListItem>
            </asp:RadioButtonList>
        </fieldset>
