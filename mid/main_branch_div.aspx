<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="main_branch_div.aspx.cs" Inherits="mid.main_branch_div" %>
         ...
         <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">اضافة مكان تسليم البضاعة</h2>
        </div>
        </div>
                <div class="card-body">
                    <div>
                            ...
                            <tbody>
                                ...
                                <tr class="jsgrid-row">
                                    <td class="jsgrid-cell">
                                        <asp:Button ID="Button3" Style="color:white; height: 30px; background-color: #007bff; width: 52px;     margin: 0 65%; border:none;" runat="server" Text="حفظ" OnClick="Button1_Click" /> 
