...
namespace mid
{
    public partial class activity_typesٌReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                report.Load(Server.MapPath("activity_typesRep.rpt"));


            TextObject to = (TextObject)report.ReportDefinition.ReportObjects["username"];
            to.Text = Session["username"].ToString();

            report.SetDataSource(todatatable.ToDataTable(i.ActivityTypes.ToList()));
            ...
            {
                CrystalReportViewer1.LogOnInfo[i].ConnectionInfo = Global.ciReportConnection;
            }

            report.SetDatabaseLogon
            (Global.ciReportConnection.UserID,Global.ciReportConnection.Password,Global.ciReportConnection.ServerName,Global.ciReportConnection.DatabaseName);
