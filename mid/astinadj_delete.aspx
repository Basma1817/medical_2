<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="astinadj_delete.aspx.cs" Inherits="mid.astinadj_delete" %>
<<<<<<< HEAD
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content-wrapper">
        ...
        <ol class="breadcrumb" style="width: 1050px;">
            <h1><small>اعدادات الحسابات < حذف حسابات التسويه بالمخازن</small></h1>
        </ol>
        <div class="row">
            <div class="col-xs-12">
