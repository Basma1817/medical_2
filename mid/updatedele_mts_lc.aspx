<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="updatedele_mts_lc.aspx.cs" Inherits="mid.updatedele_mts_lc" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="content-wrapper">

        <ol class="breadcrumb" style="width: 1050px;">
            <h1><small>البيانات الاساسية > تعديل بيانات اساسية للإعتمادات</small></h1>
        </ol>
                  ...
                  <td>
                      <asp:TextBox ID="TextBox4" runat="server"></asp:TextBox></td>--%>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DropDownList1" Style="width: 333px; border: 1px solid lightblue;" runat="server"></asp:DropDownList></td>
                                        <td>القيمه
                                        </td>
                                        <td>
                        ...
                        <div>
                            <asp:Button ID="Button1" Style="position: absolute; margin: 50px -81%; background-color: #dc3545; height: 38px; background-color: #007bff;" runat="server" Text="حفظ" OnClick="Button1_Click" />

                            <asp:Button ID="Button3" Style="position: absolute; margin: 50px -74%; height: 38px; background-color: #dc3545;" runat="server" Text="تراجع" OnClick="Button3_Click" />
                        </div>
                    </div>
                    <!-- /.box-body -->
                </div>
