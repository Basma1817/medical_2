<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="insert_mtsitems_cat.aspx.cs" Inherits="mid.insert_mtsitems_cat" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-5" style="display: flex; justify-content: flex-end">
            <asp:Button ID="Button1" runat="server" type="submit" Text="حفظ" OnClick="Button2_Click" class="btn btn-success" />
            <asp:Button ID="Button2" runat="server" Text="تراجع" OnClick="Button1_Click" class="btn btn-primary" />
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div style="display: flex">
                                                <asp:Label ID="Label25" Style="width: 20%" runat="server" Text="سعر القطعة"></asp:Label>
