<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="updatedeleastmarket.aspx.cs" Inherits="mid.updatedeleastmarket" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
<<<<<<< HEAD
    <div class="panel panel-default col-lg-12">
        <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">تعديل مندوبين تسويق</h2>
        </div>
    </div>
...
=======
    ...
    <div class="content-wrapper">
        <ol class="breadcrumb" style="width: 1050px;">
            <h1><small>الاعدادات العامة > تعديل مندوبين تسويق</small></h1>
        </ol>
...
=======
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="Label4" runat="server" Text="مندوبين التسويق"></asp:Label>
        </td>
        <td>
