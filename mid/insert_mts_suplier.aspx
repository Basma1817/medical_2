...
=======
    <div class="content-wrapper">
        <ol class="breadcrumb" style="width: 1050px;">
            <h1><small>البيانات الأساسية < اضافة البيانات الأساسية للموردين </small></h1>
        </ol>
                        ...
                        <div class="col-xs-6 col-sm-3">
                            ...
                            <table style="margin: -11px -258px; position: absolute; font-size: 13px;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox51" runat="server" Style="position: absolute; margin: -3% -156%; width: 60px; border-radius: 0px;"></asp:TextBox></td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBox53" runat="server" Style="margin:-49px 53px 0px 0px; position: absolute; border-radius: 0px;"></asp:TextBox></td>
                                </tr>

                                <tr>
                                    <td style="position: absolute; margin:-22% 104%;">مدين</td>
                                    <td>
                                        <asp:TextBox ID="TextBox54" runat="server" Style="border-radius: 0px; position: absolute; margin: -51px 55px"></asp:TextBox></td>
                                </tr>
