<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="companies_delete.aspx.cs" Inherits="mid.companies_delete" %>
                            ...
                            <tbody>
                                ...
                                <tr class="jsgrid-alt-row">
                                    ...
                                    <td class="jsgrid-cell jsgrid-align-right" style="width: 150px;">
                                        ...
                                        <asp:DropDownList ID="DropDownList2" runat="server" Style="margin-bottom: 10px; direction: rtl; width: 313px; border: 1px solid lightblue; height: 30px; padding-right: 10px;">
                                        </asp:DropDownList>
                                ...
                                <tr class="jsgrid-alt-row">
                                    <td class="jsgrid-cell">
                                        <asp:Button ID="Button4" Style="margin: 0 60%; color: white; height: 30px; background-color: #dc3545; width: 52px; border: none;" runat="server" Text="حذف" OnClick="Button4_Click" /></td>

                                    <td class="jsgrid-cell jsgrid-align-right">
                                        <asp:Button ID="Button3" Style="color: white; height: 30px; background-color: #007bff; width: 52px; border: none;" runat="server" Text="تراجع" OnClick="Button3_Click" /></td>
