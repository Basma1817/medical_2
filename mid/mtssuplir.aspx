        ...
        <div class="row">
            <div class="col-lg-9" style="display: flex; justify-content: right">
                <ul class="nav nav-pills" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="pill" href="#info">حركة الموردين</a>
                    </li>
                    <li class="nav-item">
...
=======
    <ol class="breadcrumb">
        <h1 style="padding-left: 690px;"><small style="font-size: 80%; font-weight: 400;">البيانات الأساسية > بيانات الموردين</small></h1>
    </ol>
        ...
        <div class="content" style="border-style: hidden;">
            ...
            <div class="tab-content">
                <div id="basicinfo" class="container tab-pane active">
                    ...
                    <%--<asp:Button ID="Button5" runat="server" Text="اضافة مورد جديد" OnClick="Button5_Click" Style="margin: -4% -57%; position: absolute; border-radius: unset; padding: 5px; width:115px; background: #c6d3e6; font-size: 15px;" />--%>

                    <asp:Button ID="Button2" runat="server" Text="إضافة" OnClick="Button2_Click" Style="margin: -340px 0px -115px 347px; padding: 6px; background: dodgerblue; font-size: 15px;"
                        class="btn btn-success" />

                    <asp:HyperLink ID="HyperLink1" runat="server" class="btn btn-primary" data-target="#loginModal" data-toggle="modal" href="#" Style="background-color: darkred; margin: -118px -344px; position: absolute; width: 63px; padding: 6px; border color: unset;">حذف</asp:HyperLink>

                    <asp:Button ID="Button1" runat="server" Text="تعديل" OnClick="Button1_Click" Style="position: absolute; margin: -118px -273px; padding: 6px;" />

                    <asp:Button ID="Button3" runat="server" Text="طباعة" class="btn btn-success" Style="margin: -213px -198px 11px 168px; background: lightseagreen; font-size: 15px; padding: 6px;"
                ...
                <div id="respppl" class="container tab-pane fade">
                    ...
                    <%--<div>
                                ...
                                <asp:TreeView ID="TreeView2" runat="server" OnTreeNodePopulate="TreeView1_TreeNodePopulate" Font-Bold="False" Font-Size="Medium" OnSelectedNodeChanged="TreeView1_SelectedNodeChanged" ShowLines="True" Style="font-size: Medium; font-weight: normal; position: absolute; border: 1px solid #5423B5; margin-right: -377px; margin-top: -57px; min-height: 1460px; width: 333px;">
                                </asp:TreeView>
                            </div>--%>
                    <%-- <div>
                                <asp:GridView ID="GridView2" runat="server" CssClass="table table-striped" BackColor="White" Style="font-size: 12px; margin: -365px 415px; width: 660px; text-align: center; border-color: #5bc0de;"></asp:GridView>
                            </div>--%>
