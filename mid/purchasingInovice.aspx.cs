...
namespace mid
{
    public partial class purchasingInovice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            txtTotalPriceFooter.Attributes.Add("readonly", "readonly");
            txtAfterDiscountFooter.Attributes.Add("readonly", "readonly");
            txtDiscountItemsFooter.Attributes.Add("readonly", "readonly");
            txtTaxFooter.Attributes.Add("readonly", "readonly");
            txtNetFooter.Attributes.Add("readonly", "readonly");
            foreach (GridViewRow row in grdPurchasing.Rows)
            {
                TextBox txtItemPrice = row.FindControl("txtItemPrice") as TextBox;
                TextBox txtTaxQuantity = row.FindControl("txtTaxQuantity") as TextBox;
                TextBox txtUnitCost = row.FindControl("txtUnitCost") as TextBox;
                ImageButton ButtonAdd = row.FindControl("ButtonAdd") as ImageButton;

                txtItemPrice.Attributes.Add("readonly", "readonly");
                txtTaxQuantity.Attributes.Add("readonly", "readonly");
            ...
            dateRecieving.Text= DateTime.Now.ToString("yyyy/MM/dd", new System.Globalization.CultureInfo("ar-EG"));
            if (!Page.IsPostBack)
            {
                //Islam 8-10-2019
                        ...
                        using (SqlConnection con = new SqlConnection(constr))
                        {
                            using (SqlCommand cmd = new SqlCommand("select Itm_No,Itm_Pur,Itm_Sal2 from MtsItmmfs where Itm_No=@Itm_No"))
                            {
                                ...
                                while (dr.Read())
                                {
                                    ...
                                    txtUnitCost.Text= dr["Itm_Pur"].ToString();
        ...
        protected void grdPurchasing_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            TextBox txtTotalPrice = (TextBox)e.Row.FindControl("txtTotalPrice") as TextBox;
            TextBox txtItemPrice = (TextBox)e.Row.FindControl("txtItemPrice") as TextBox;
        ...
        protected void grdPurchasing_RowCreated(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                DataTable dt = (DataTable)ViewState["CurrentTable"];
                ImageButton lb = (ImageButton)e.Row.FindControl("LinkDelete");
                if (lb != null)
                {
                    if (dt.Rows.Count > 1)
                    {
        ...
        protected void LinkDelete_Click(object sender, EventArgs e)
        {
            foreach (GridViewRow row in grdPurchasing.Rows)
            {
                ImageButton LinkDelete = row.FindControl("LinkDelete") as ImageButton;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (drpBranch.SelectedIndex != 0)
            {
                ...
                foreach (GridViewRow row in grdPurchasing.Rows)
                {
                    ...
                    string insertStatement = "IF NOT EXISTS (SELECT * FROM InvLodhdr WHERE Doc_No=@Doc_No) INSERT INTO InvLodhdr (StoreID,Doc_Ty,Doc_No,Dlv_Stor,Doc_Dt,Doc_DtAr,RcvngPur_Dt,Pym_Dt,Pym_No,Sup_No,Sup_Inv,Curncy_No,ExchangeRate,Notes,Tot_Pur,Tot_Cost,Tot_Disc,Net,Taxv_ExtraTot) VALUES (@StoreID,2,@Doc_No,@Dlv_Stor,@Doc_Dt,@Doc_DtAr,@RcvngPur_Dt,@Pym_Dt,@Pym_No,@Sup_No,@Sup_Inv,@Curncy_No,@ExchangeRate,@Notes,@Tot_Pur,@Tot_Cost,@Tot_Disc,@Net,@Taxv_ExtraTot) ELSE UPDATE InvLodhdr set StoreID=@StoreID,Doc_Ty=2,Doc_No=@Doc_No where Doc_No=@Doc_No; insert into InvLoddtl (StoreID,Doc_Ty,Doc_No,Dlv_Stor,Qty,Loc_No,Unit_No,Ln_No,Itm_No,Itm_Cost,Titm_Cost,Exp_Date, Batch_No,Disc1_Prct,Disc1_Val,Disc2_Prct,BonusPur_Prct,BonusPur_Qty,Itm_Sal,Titm_Sal,taxp_Extra,taxv_Extra,Itm_Pur,Titm_Pur) values(@StoreID,'2',@Doc_No,@Dlv_Stor,@Qty,@Loc_No,@Unit_No,@RowNumber,@Itm_No,@Itm_Cost,@Titm_Cost,@Exp_Date,@Batch_No,@Disc1_Prct,@Disc1_Val,@Disc2_Prct,@BonusPur_Prct,@BonusPur_Qty,@Itm_Sal,@Titm_Sal,@taxp_Extra,@taxv_Extra,@Itm_Pur,@Titm_Pur)";
        ...
        protected void txtQuantity_OnPreRender(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in grdPurchasing.Rows)
            {
                ...
                //     txtTotalPrice.Attributes.Add("onkeyup", "calBal();");
                txtQuantity.Attributes.Add("onkeyup", "calBal();");
                txtUnitPrice.Attributes.Add("onchange", "calBal();");
                //txtDiscountQuantity.Attributes.Add("onkeyup", "calBal2();");
                txtQuantity.Attributes.Add("onchange", "calBal2();");

                txtDiscountQuantity.Attributes.Add("onkeyup", "calBal();");

                txtDiscountPur2.Attributes.Add("onkeyup", "calBal();");
        ...
        protected void txtDiscountPur1_OnPreRender(object sender, EventArgs e)
        {
            foreach (GridViewRow row in grdPurchasing.Rows)
            {
                ...
                txtDiscountPur1.Attributes.Add("onchange", "calBal2();");
                txtTotalPrice.Attributes.Add("onchange", "calBal2();");
           //     txtDiscountQuantity.Attributes.Add("onkeyup", "calBal()2;");
        ...
        //    txtAfterDiscountFooter.Text = total.ToString("N2");
            ...
            foreach (GridViewRow row in grdPurchasing.Rows)
            {
              ...
              //  txtTaxQuantity.Text = (output * output2 / 100).ToString();
                ...
                txtTax.Attributes.Add("onkeyup", "calBal3();");
                txtTax.Attributes.Add("onchange", "calBal3();");
                txtQuantity.Attributes.Add("onchange", "calBal3();");
        ...
        protected void txtBonusPur_OnTextChanged(object sender, EventArgs e)
        {
            foreach (GridViewRow row in grdPurchasing.Rows)
            {
             ...
             //   txtBonusQuantity.Text = (output3 * output4 / 100).ToString("N2");
                ...
                //   txtQuantity.Attributes.Add("onfocusout", "calBal6();");
        ...
        protected void txtBonusPur_PreRender(object sender, EventArgs e)
        {
            foreach (GridViewRow row in grdPurchasing.Rows)
            {
                ...
                //txtBonusPur.Attributes.Add("onkeyup", "calBal();");
                //txtQuantity.Attributes.Add("onfocusout", "calBal();");
                //txtBonusPur.Attributes.Add("onchange", "calBal();");
        ...
        protected void txtNetFooter_PreRender(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in grdPurchasing.Rows)
            {
                ...
                txtAfterDiscountFooter.Attributes.Add("onchange", "calBal5();");
                txtTaxFooter.Attributes.Add("onchange", "calBal5();");
                txtAdditionalDiscountFooter.Attributes.Add("onkeyup", "calBal5();");
                txtQuantity.Attributes.Add("onfocusout", "calBal5();");
                txtDiscountPur1.Attributes.Add("onkeyup", "calBal5();");
                txtDiscountPur2.Attributes.Add("onchange", "calBal5();");
                txtTax.Attributes.Add("onfocusout", "calBal5();");
                txtDiscountQuantity.Attributes.Add("onfocusout", "calBal5();");
        ...
        protected void txtDiscountItemsFooter_PreRender(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in grdPurchasing.Rows)
            {
                ...
                txtDiscountQuantity.Attributes.Add("onfocusout", "calBal4();");
                txtDiscountPur1.Attributes.Add("onfocusout", "calBal4();");
                txtDiscountPur2.Attributes.Add("onfocusout", "calBal4();");
