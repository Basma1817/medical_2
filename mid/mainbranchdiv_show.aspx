<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="mainbranchdiv_show.aspx.cs" Inherits="mid.mainbranchdiv_show" %>
         ...
         <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">عرض مكان تسليم البضاعة</h2>
        </div>
        </div>
                <div class="card-body">
                    <div>
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                ...
                                <tr class="jsgrid-row">
                                    ...
                                    <td class="jsgrid-cell jsgrid-align-right">
                                        <asp:Button ID="Button3" Style="color: white; height: 30px; background-color: #dc3545; width: 52px; border: none; margin: 0 112%;" runat="server" Text="تراجع" OnClick="Button3_Click" />
                                    </td>
