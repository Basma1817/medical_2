<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="mts_custm_show.aspx.cs" Inherits="mid.mts_custm_show" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div class="content-wrapper">
        <ol class="breadcrumb" style="width: 1050px;">
            <h1><small>البيانات الاساسيه < عرض البيانات الاساسيه للعملاء </small></h1>
        </ol>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <asp:Button ID="Button3"  Style="margin: 3px 82% 0 0;height: 30px;background-color: #dc3545;width: 52px;" runat="server" Text="تراجع" OnClick="Button3_Click" />
