<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="salesman_show.aspx.cs" Inherits="mid.salesman_show" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
<<<<<<< HEAD
    <div class="panel panel-default col-lg-12">
        <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">عرض مندوبين مبيعات</h2>
        </div>
    </div>
    <div class="row">
...
=======
     ...
     <div class="content-wrapper">
        ...
        <ol class="breadcrumb" style="width: 1050px;">
            <h1><small> اعدادات المبيعات < عرض مندوبين المبيعات</small></h1>
        </ol>
