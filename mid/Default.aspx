<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="mid.main" %>
<!DOCTYPE html>
<html lang="en-US" data-bt-theme="Medicare 1.4.9">
<head>
...
<link rel='stylesheet'  href='wp-includes/css/slider.css'/>
        <link href="Content/newsticker.css" rel="stylesheet" />
...
<body class="home page-template-default page page-id-983 bodyPreloader btMenuRightEnabled btStickyEnabled btLightSkin btMenuGutter btCapitalizeMainMenuItems btHardRoundedButtons btNoSidebar bt_bb_plugin_active bt_bb_fe_preview_toggle woocommerce-no-js ">
	...
	<div id="3" class="ln_wrapper" style="margin-top:0; width:100% ">
		<div id="4" class="ln_left">
			<p> الاخبار </p>
		</div>
		<div id="2" class="ln_left_arrow"></div>
		<div id="1" class="ln_right marquee" data-duration='15000' >
			<ul>
		    	<li> مؤسسة عاصم عمر القثمي للتجارة </li>
		    </ul>
		</div>
	</div>
<!-- partial -->
...
<div  class="menuPort" >
	<nav style="direction:rtl;font-size:14px;font-weight:500;">

		<ul id="menu-main-menu" class="menu" style="display: flex;font-weight:500; font-size:16px">
		...
		<li id="menu-item-1624" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1624"><a style="font-weight:500;" href="design/products.aspx">منتجاتنا</a></li>
		<li id="menu-item-1624" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1624"><a href="design/customer.aspx">العملاء</a></li>
		<li id="menu-item-1624" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1624"><a href="design/suppliers.aspx">الموردين</a></li>
		<li id="menu-item-1624" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1624"><a href="design/orders.aspx">الطلبات</a></li>
		<li id="menu-item-1624" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1624"><a href="design/jobs.aspx"> طلبات الوظائف</a></li>

		<li id="menu-item-1409" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1409"><a href="design/news.aspx">الاخبار </a></li>
		...
		<a href="design/contact.aspx">أتصل بنا</a></li>
		<li id="menu-item-1395" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1395"><a href="design/partners.aspx">الشركاء</a></li>
		<li id="menu-item-1395" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1395"><a href="design/login.aspx">تسجيل الدخول</a></li>
	  ...
	  <header>
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
		  ...
		  <div class="carousel-inner" role="listbox">
			...
			<div class="carousel-item active" style="background-image: url('wp-content/image/022e9691c5ba65d23cbf27a53f83163e.jpg')">
			  <div class="carousel-caption d-none d-md-block">
				...
				font-size: 103px;
				font-weight: bolder;"
				 class="display-4">First Slide</h2>
				<p class="lead">This is a description for the first slide.</p>
			  </div>
			</div>
			<!-- Slide Two - Set the background image for this slide in the line below -->
			<div class="carousel-item" style="background-image: url('wp-content/image/465731298.jpg.0.jpg')">
			  <div class="carousel-caption d-none d-md-block">
				<h2 style=
				"position: relative;
				bottom: 358px;
				font-size: 103px;
				font-weight: bolder;"
				class="display-4">Second Slide</h2>
			...
			<div class="carousel-item" style="background-image: url('wp-content/image/Pharmacy-in-Gozo.jpg')">
			  <div class="carousel-caption d-none d-md-block">
				<h2 style=
				"position: relative;
				bottom: 358px;
				...
				"
				class="display-4">Third Slide</h2>
				<p class="lead">This is a description for the third slide.</p>
			  </div>
			</div>
			<!-- Slide four - Set the background image for this slide in the line below -->
			<div class="carousel-item" style="background-image: url('wp-content/image/ulta-makeup.jpg')">
			  <div class="carousel-caption d-none d-md-block">
				<h2 style=
				"position: relative;
				bottom: 358px;
...
<div class="bt_bb_wrapper">
	...
	<section id="bt_section5d807fd49b661"  class="boldSection topSemiSpaced bottomSemiSpaced btDarkSkin gutter inherit" style="background-color:#0176d5;"><div class="port"><div class="boldCell"><div class="boldCellInner"><div class="boldRow  bt_bb_hidden_xs bt_bb_hidden_ms bt_bb_hidden_sm" ><div class="boldRowInner"><div class="rowItem col-md-8 col-ms-12 btTextLeft"  ><div class="rowItemContent" ><div class="btIconImageRow" ><div class="bpgPhoto btTextCenter" ><div class = "btImage"><img src="wp-content/uploads/sites/14/2018/03/general-hospital-logo-footer.png" alt="" ></div></div></div><div class="btClear btSeparator bottomSemiSpaced noBorder bt_bb_hidden_md bt_bb_hidden_lg" ><hr></div></div></div><div class="rowItem col-md-4 col-ms-12 btTextCenter btMiddleVertical btNoPadding"  ><div class="rowItemContent" ><div class="btText" ><p>Visit us on social networks:</p>
	...
	</div><div class="btIconImageRow" ><span class="btIco btIcoFilledType btIcoSmallSize btIcoDefaultColor   " ><a href="http://www.facebook.com/"  target = "no_target" data-ico-fa="&#xf09a;" class="btIcoHolder"><em></em></a></span><span class="btIco btIcoFilledType btIcoSmallSize btIcoDefaultColor   " ><a href="http://www.twitter.com/"  target = "no_target" data-ico-fa="&#xf099;" class="btIcoHolder"><em></em></a></span><span class="btIco btIcoFilledType btIcoSmallSize btIcoDefaultColor   " ><a href="http://www.linkedin.com/"  target = "no_target" data-ico-fa="&#xf0e1;" class="btIcoHolder"><em></em></a></span></div></div></div></div></div><div class="boldRow  " ><div class="boldRowInner"><div class="rowItem col-md-12 col-ms-12  btTextLeft"  ><div class="rowItemContent" >
	</div></div></div></div>
	
	<div class="btClear btSeparator bottomSmallSpaced noBorder" ><hr></div></div></div><div class="rowItem col-md-4 col-ms-12 btTextCenter inherit btNoPadding"  ><div class="rowItemContent" ><header class="header btClear large  btNormalDash" ><div class="dash"><h2><span class="headline"><strong class="animate">0-800-777-2331</strong></span></h2></div></header><div class="btClear btSeparator bottomExtraSmallSpaced noBorder" ><hr></div><div class="btText" ><p>Contact us now If you need equipment, medicines and all necessary health, we will reply quickly and give you medical aid.</p>
	</div><div class="btClear btSeparator topSmallSpaced noBorder bt_bb_hidden_md bt_bb_hidden_lg" ><hr></div></div></div></div></div>
...
{"ajax_url":"\/general-hospital\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/general-hospital\/?wc-ajax=%%endpoint%%","i18n_view_cart":"View cart","cart_url":
"http:\/\/medicare.bold-themes.com\/general-hospital\/shop\/cart\/","is_cart":"","cart_redirect_after_add":"no"};
</script>
...
<script src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>
   <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.1/jquery.min.js'></script>
    <script src='https://cdn.jsdelivr.net/jquery.marquee/1.4.0/jquery.marquee.min.js'></script>
        <script  src="Content/newsticker.js"></script>
<script src="wp-includes/js/slider.js"></script>
