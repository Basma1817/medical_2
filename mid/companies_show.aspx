<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="companies_show.aspx.cs" Inherits="mid.companies_show" %>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                ...
                                <tr class="jsgrid-alt-row">
                                    ...
                                    <td class="jsgrid-cell jsgrid-align-right" style="width: 150px;">
                                        <asp:DropDownList ID="DropDownList2" Enabled="false" runat="server"
                                            Style="margin-bottom: 10px; direction: rtl; width: 313px; border: 1px solid lightblue; height: 30px; padding-right: 10px;">
                                        </asp:DropDownList></td>
                                ...
                                <tr class="jsgrid-alt-row">
                                    ...
                                    <td class="jsgrid-cell jsgrid-align-right" style="width: 150px;">
                                        <asp:Button ID="Button3" Style="margin: 0 110%; color: white; height: 30px; background-color: #dc3545; width: 52px; border: none;" runat="server" Text="تراجع" OnClick="Button3_Click" /></td>
