<<<<<<< HEAD
﻿<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="update_mts_emp_cntrct.aspx.cs" Inherits="mid.update_mts_emp_cntrct" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div class="panel panel-default col-lg-12">
        <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">تعديل البيانات الاساسية للموظفين </h2>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-5">
    ...
    <div class="row">
        <div class="col-lg-5" style="display: flex; justify-content: flex-end">
              <asp:Button ID="Button1" runat="server" type="submit" Text="حفظ" OnClick="Button3_Click" class="btn btn-success" />

            <asp:Button ID="Button2" runat="server" type="submit" Text="تراجع" OnClick="Button3_Click" class="btn btn-success" />
...
<%--    <div class="content-wrapper">--%>
        <ol class="breadcrumb" style="width: 1050px;">
            <h1><small>البيانات الاساسية < تعديل البيانات الأساسية للموظفين</small></h1>
        </ol>
