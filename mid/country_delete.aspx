<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="country_delete.aspx.cs" Inherits="mid.country_delete" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">حذف دولة </h2>
        </div>
        </div>
