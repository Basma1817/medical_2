<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="insert_mts_emp_cntrct.aspx.cs" Inherits="mid.insert_mts_emp_cntrct" %>
...
<<<<<<< HEAD
        ...
        <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">اضافة بيانات الموظفين</h2>
        </div>
    </div>
...
=======
       ...
       <div class="content-wrapper">
        <div class="panel panel-default col-lg-12">
        <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">البيانات الاساسية للموظفين</h2>
        </div>
        </div>
