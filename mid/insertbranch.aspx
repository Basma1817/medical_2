...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <section class="content-header">
         ...
         <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">اضافة فرع</h2>
        </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <tr class="jsgrid-row">
                                    <td class="jsgrid-cell">
                                        <asp:Button ID="Button3" Style="color:white; height: 30px; background-color: #007bff; width: 52px;     margin: 0 60%; border:none;" runat="server" Text="حفظ" OnClick="Button1_Click" />
                                    </td>
