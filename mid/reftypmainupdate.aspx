<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="reftypmainupdate.aspx.cs" Inherits="mid.reftypmainupdate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-default col-lg-12" dir="rtl">
        <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">تعديل مرجع</h2>
        </div>
    </div>
     ...
     <div class="row">
        ...
        <div class="col-lg-5" style="display: flex; justify-content: flex-end" >
             ...
             <asp:Button ID="Button1" runat="server" Text="حفظ" OnClick="Button1_Click" class="btn btn-primary" />
