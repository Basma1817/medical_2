<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="insert_earn_type.aspx.cs" Inherits="mid.insert_earn_type" %>
...
<<<<<<< HEAD
    <div class="panel panel-default col-lg-12">
        <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">أضافة أنواع الاستحقاقات</h2>
        </div>
    </div>
...
=======
    <div class="content-wrapper">
        <ol class="breadcrumb" style="width: 1050px;">
            <h1><small>اعدادات الموظفين < اضافة انواع الاستحقاقات</small></h1>
        </ol>
